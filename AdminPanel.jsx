...
export default function AdminPanel({ onLogout }) {
  ...
  return <main className="admin-page min-h-screen bg-zinc-950 text-[var(--text-color)]" data-admin-root="true"><div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 sm:py-7">
    ...
    {loading ? <div className="admin-loading">Loading dashboard…</div> : tab === 'Overview' ? <AdminOverview chapters={sorted} comments={comments} reports={reports} ratings={ratings} views={views} likes={likes} pageCounts={pageCounts} onTab={setTab} chapterName={chapterName} /> : tab === 'Pal Do Pal Ke Lamhe' ? <PalDoPalAdmin embedded /> : tab === 'Pages' ? <section className="admin-stack">
