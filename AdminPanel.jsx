...
export default function AdminPanel({ onLogout }) {
  ...
  const tabs = ['Overview', 'Chapters', 'Pages', 'Comments', 'Reports', 'Announcements', 'Media'];
