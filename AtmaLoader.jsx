...
.atma-loader .symbol{position:absolute;inset:20px;animation:symbolRotate 12s ease-in-out infinite;z-index:4}.atma-loader svg{width:100%;height:100%;overflow:visible}.atma-loader .mark{fill:none;stroke:rgba(255,255,255,.7);stroke-width:1.3;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:80 180;animation:markFlow 3.2s linear infinite,markPulse 4s ease-in-out infinite}.atma-loader .mark.two{stroke-dasharray:45 220;animation-delay:-1.7s}.atma-loader .mark.three{stroke-dasharray:25 260;animation-delay:-2.6s}
.atma-loader .thread{position:absolute;left:50%;top:50%;width:2px;height:80px;transform-origin:50% 100%;border-radius:100%;background:linear-gradient(to top,rgba(255,255,255,.95),rgba(255,255,255,.45),transparent);z-index:6}.atma-loader .thread.one{animation:seekerOne 4.2s ease-in-out infinite}.atma-loader .thread.two{animation:seekerTwo 5s ease-in-out infinite}.atma-loader .thread:after{content:"";position:absolute;left:50%;top:0;width:8px;height:100%;transform:translateX(-50%);background:inherit;opacity:.13;filter:blur(5px)}
.atma-loader .fragments{position:absolute;inset:0;pointer-events:none;z-index:8}.atma-loader .fragment{position:absolute;left:50%;top:50%;width:1px;height:6px;border-radius:100%;background:rgba(255,255,255,.9);box-shadow:0 0 4px rgba(255,255,255,.45);opacity:0;animation:fragmentOrbit var(--duration) ease-in-out infinite;animation-delay:var(--delay)}
.atma-loader .burst{position:absolute;left:50%;top:50%;width:10px;height:10px;transform:translate(-50%,-50%);border-radius:50%;z-index:15;pointer-events:none;animation:burstPulse 5.8s ease-out infinite}.atma-loader .burst span{position:absolute;left:50%;top:50%;width:1px;height:7px;border-radius:100%;background:linear-gradient(to top,rgba(255,255,255,.95),transparent);transform-origin:50% 0;opacity:0;animation:sparkBurst 5.8s ease-out infinite}
.atma-loader .node{position:absolute;left:50%;top:50%;width:5px;height:5px;border-radius:50%;background:white;box-shadow:0 0 10px rgba(255,255,255,.7);z-index:20}.atma-loader .node.one{animation:nodeOne 4.2s ease-in-out infinite}.atma-loader .node.two{animation:nodeTwo 5s ease-in-out infinite}.atma-loader .center{position:absolute;left:50%;top:50%;width:5px;height:5px;transform:translate(-50%,-50%);border-radius:50%;background:white;box-shadow:0 0 12px rgba(255,255,255,.8);z-index:25;animation:centerPulse 2.5s ease-in-out infinite}
@keyframes fragmentOrbit{0%{transform:translate(-50%,-50%) rotate(var(--angle)) translateY(calc(var(--radius) - 18px)) scale(.15);opacity:0}15%{opacity:.12}32%{opacity:.85}50%{transform:translate(-50%,-50%) rotate(calc(var(--angle) + var(--drift))) translateY(var(--radius)) scale(1);opacity:.7}68%{transform:translate(-50%,-50%) rotate(calc(var(--angle) + var(--drift) + 18deg)) translateY(calc(var(--radius) + 9px)) scale(.65);opacity:.3}82%{opacity:.06}100%{transform:translate(-50%,-50%) rotate(calc(var(--angle) + var(--drift) + 35deg)) translateY(calc(var(--radius) + 18px)) scale(.05);opacity:0}}
@keyframes sparkBurst{0%,45%{transform:rotate(var(--r)) translateY(3px) scaleY(.2);opacity:0}50%{opacity:1}62%{transform:rotate(var(--r)) translateY(32px) scaleY(1);opacity:.75}72%{transform:rotate(var(--r)) translateY(45px) scaleY(.35);opacity:0}100%{opacity:0}}
@keyframes burstPulse{0%,42%{transform:translate(-50%,-50%) scale(.15);opacity:0}50%{transform:translate(-50%,-50%) scale(.8);opacity:1}60%{transform:translate(-50%,-50%) scale(1.15);opacity:.7}70%,100%{transform:translate(-50%,-50%) scale(1.5);opacity:0}}
@keyframes symbolRotate{0%{transform:rotate(-12deg) scale(.92)}50%{transform:rotate(12deg) scale(1.04)}100%{transform:rotate(-12deg) scale(.92)}}
@keyframes markFlow{from{stroke-dashoffset:0}to{stroke-dashoffset:-260}}@keyframes markPulse{0%,100%{opacity:.12}40%{opacity:.7}60%{opacity:.35}}
...
@keyframes seekerTwo{0%{transform:translate(-50%,-100%) rotate(50deg) scaleY(.6);opacity:.25}25%{transform:translate(-50%,-100%) rotate(130deg) scaleY(1.1);opacity:.9}45%{transform:translate(-50%,-100%) rotate(210deg) scaleY(.7);opacity:1}65%{transform:translate(-50%,-100%) rotate(285deg) scaleY(1.15);opacity:.8}80%{transform:translate(-50%,-100%) rotate(345deg) scaleY(.5);opacity:.3}100%{transform:translate(-50%,-100%) rotate(410deg) scaleY(.6);opacity:.25}}
@keyframes nodeOne{0%{transform:translate(-50%,-50%) rotate(-140deg) translateY(42px);opacity:.2}40%{transform:translate(-50%,-50%) rotate(15deg) translateY(78px);opacity:1}75%{transform:translate(-50%,-50%) rotate(150deg) translateY(52px);opacity:.3}100%{opacity:.2}}
