...
export default function AdminManagementTools(){
  ...
  const openView=type=>{setQuery('');setStatus('all');setError('');setOpen(type);if(type==='users')loadUsers();if(type==='notifications')loadNotifications();if(type==='activity')loadActivity()};
