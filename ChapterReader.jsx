            ...
            <div className="pt-20 pb-12">
                ...
                {!chapter.pdfUrl && (!chapter.pages || chapter.pages.length === 0) && (
                    <div className="mx-auto max-w-3xl px-6">
                        <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-zinc-200 bg-[var(--card-bg)] py-20 dark:border-zinc-800 dark:bg-zinc-900">
                            ...
                            <h3 className="font-semibold text-zinc-900 dark:text-[var(--text-color)]">No content available</h3>
            ...
            <div className="relative mb-6">
                ...
                <div className="relative overflow-hidden rounded-lg bg-zinc-100 dark:bg-zinc-900 shadow-sm border border-zinc-200 dark:border-zinc-800">
                    ...
                    <div
                        ...
                        title="Previous Page"
                    >
                        {currentIndex > 0 && <i className="fas fa-chevron-left text-3xl text-[var(--text-color)]/70 drop-shadow-md"></i>}
                    </div>
                    <div
                        ...
                        title="Next Page"
                    >
                        {currentIndex < pages.length - 1 && <i className="fas fa-chevron-right text-3xl text-[var(--text-color)]/70 drop-shadow-md"></i>}
                    </div>
                </div>
            </div>
