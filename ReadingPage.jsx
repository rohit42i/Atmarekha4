    ...
    return (
      <main className="min-h-screen bg-zinc-50 pt-24 px-6 pb-20 dark:bg-zinc-950">
        <div className="mx-auto max-w-6xl">
          <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-[var(--text-color)] mb-2">Library</h1>
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {allStories.map(story => (
                <div
                  ...
                  className="group relative cursor-pointer overflow-hidden rounded-2xl bg-[var(--card-bg)] shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl dark:bg-zinc-900 ring-1 ring-zinc-200 dark:ring-zinc-800"
                >
                  <div className="aspect-[3/4] w-full overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                      <span className="rounded-full bg-[var(--card-bg)]/20 px-6 py-2.5 font-semibold text-[var(--text-color)] backdrop-blur-md transition hover:bg-[var(--card-bg)]/30">
                        Read Now
                      </span>
                    </div>
                  </div>
                  <div className="absolute bottom-0 left-0 right-0 p-5 pt-12 text-[var(--text-color)] bg-gradient-to-t from-black/90 to-transparent">
  ...
  return (
    <main className="min-h-screen pb-20 bg-zinc-50 dark:bg-zinc-950">
      ...
      <div className="relative h-[60vh] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-end px-6 pb-12 text-center sm:flex-row sm:items-end sm:justify-start sm:gap-10 sm:px-10 sm:text-left mx-auto max-w-6xl">
          ...
          <div className="flex-1 pb-2">
            <h1 className="text-4xl font-extrabold tracking-tight text-zinc-900 dark:text-[var(--text-color)] sm:text-6xl drop-shadow-sm">{story.title}</h1>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-4 sm:justify-start">
              ...
              <button
                ...
                className={`flex items-center gap-2 rounded-full px-6 py-2 text-sm font-bold shadow-lg transition hover:scale-105 ${hasLiked
                  ? 'bg-rose-600 text-[var(--text-color)] shadow-rose-600/30'
                  : 'bg-[var(--card-bg)]/80 text-rose-600 backdrop-blur hover:bg-[var(--card-bg)] dark:bg-[var(--bg-color)]/50 dark:text-rose-400'
                  }`}
              >
              ...
              {chapters.length > 0 && (() => {
                ...
                return firstChapterId ? (
                  <a
                    ...
                    className="flex items-center gap-2 rounded-full bg-blue-600 px-6 py-2 text-sm font-bold text-[var(--text-color)] shadow-lg shadow-blue-600/30 transition hover:bg-blue-700 hover:scale-105"
                  >
              ...
              <span className="rounded-full border border-zinc-200 bg-[var(--card-bg)]/50 px-4 py-2 text-sm font-semibold text-zinc-600 backdrop-blur dark:border-zinc-700 dark:bg-zinc-800/50 dark:text-zinc-300">
      ...
      <div className="mx-auto max-w-4xl px-6 -mt-8 relative z-20">
        {/* Description Card */}
        <div className="mb-10 rounded-2xl bg-[var(--card-bg)] p-8 shadow-sm ring-1 ring-zinc-200 dark:bg-zinc-900 dark:ring-zinc-800">
          <h3 className="mb-3 text-lg font-bold text-zinc-900 dark:text-[var(--text-color)]">Synopsis</h3>
        ...
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-[var(--text-color)]">Episodes</h2>
          ...
          {chapters.length > 0 ? (
            [...chapters]
              ...
              .map((ch, index) => (
                <div
                  key={ch._id}
                  className="group relative flex items-center justify-between rounded-xl bg-[var(--card-bg)] p-4 shadow-sm ring-1 ring-zinc-100 transition-all duration-300 hover:scale-[1.01] hover:shadow-md hover:ring-blue-500/20 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:ring-blue-500/30"
                >
                  <a href={`#read-chapter/${ch._id}`} className="flex flex-1 items-center gap-5">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-blue-50 font-bold text-blue-600 transition-colors group-hover:bg-blue-600 group-hover:text-[var(--text-color)] dark:bg-blue-900/20 dark:text-blue-400">
                      {ch.chapterNumber}
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="truncate font-bold text-zinc-900 transition-colors group-hover:text-blue-600 dark:text-[var(--text-color)]">{ch.title}</h3>
            ...
            <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-zinc-200 bg-zinc-50 py-16 text-center dark:border-zinc-800 dark:bg-zinc-900/50">
              ...
              <h3 className="font-semibold text-zinc-900 dark:text-[var(--text-color)]">No episodes yet</h3>
