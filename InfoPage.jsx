...
const PAGES = {
  about: {
    ...
    story: [
      'Atma Rekha is an Indian adventure manga/comic where random dreams, imaginations, stories, ancient lore, spiritual traditions, and forgotten histories come to life.',
